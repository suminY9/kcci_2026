...
#Buttons
set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVCMOS33} [get_ports user_reset_btn]
...
##Pmod Header JA (XADC)
# set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports echo]
# set_property -dict {PACKAGE_PIN L14 IOSTANDARD LVCMOS33} [get_ports trigger]
# set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS33} [get_ports pwm]
...
##Pmod Header JE
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports echo]
set_property -dict {PACKAGE_PIN W16 IOSTANDARD LVCMOS33} [get_ports trigger]
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports pwm]
set_property -dict {PACKAGE_PIN H15 IOSTANDARD LVCMOS33} [get_ports tx]
