...
timing_t const timing[] = {
		...
		{Resolution::R1920_1080_30_PP, 1920, 88, 44, 148, timing_t::POS, 1080, 4, 5, 36, timing_t::POS, 74250000},
		{Resolution::R1280_720_60_PP, 1280, 110, 40, 220, timing_t::POS, 720, 5, 5, 20, timing_t::POS, 74250000},
		// 640x480은 표준 VESA 타이밍이 NEG 극성. POS로 바꿔서 테스트해봤지만
		// 화면 깜빡임 해결 안 됨 - 원인은 극성이 아니라 DVI 시리얼클럭(125MHz)이
		// rgb2dvi kClkRange=1의 최소 기준(120MHz)에 턱걸이라 MMCM lock이
		// 불안정한 것이었음. 원래 규격대로 NEG로 되돌림.
