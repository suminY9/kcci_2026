...
extern void LED_INT_On(void);
extern void LED_INT_Off(void);
extern void LED_INT_Toggle(void);
extern void LED_EXT_On(void);
extern void LED_EXT_Off(void);
extern void LED_EXT_Toggle(void);
